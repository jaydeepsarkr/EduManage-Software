<template>
  ...
  <div class="min-h-screen bg-gray-50">
    ...
    >
      ...
      <!-- Student Details Modal - Enhanced Responsive Styling -->
      <div
        v-if="showDetailsModal"
        class="fixed inset-0 z-50 bg-black bg-opacity-60 flex items-center justify-center p-2 sm:p-4"
      >
        <div
          class="bg-white w-full max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-6xl max-h-[98vh] sm:max-h-[95vh] rounded-lg border border-gray-200 relative animate-fade-in flex flex-col mx-2 sm:mx-4"
        >
          <!-- Modal Loading Overlay -->
          <div
          ...
          >
            <div class="text-center px-4">
              <div
                class="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 border-2 sm:border-3 border-blue-200 border-t-blue-600 rounded-full animate-spin mx-auto mb-2"
              ></div>
              <p class="text-xs sm:text-sm text-gray-600">
          ...
          <!-- Fixed Header - Enhanced Responsive -->
          <div class="flex-shrink-0 p-3 sm:p-4 md:p-6 border-b border-gray-200">
            <!-- Close Button -->
            <button
              @click="closeDetailsModal"
              :disabled="isDetailsLoading"
              class="absolute top-2 right-2 sm:top-3 sm:right-3 md:top-4 md:right-4 p-1.5 sm:p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed z-20"
              title="Close"
            >
              <X class="w-4 h-4 sm:w-5 sm:h-5" />
            </button>
            ...
            <!-- Header Content -->
            <div
              class="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 pr-8 sm:pr-12"
            >
              ...
              <div class="flex-1 min-w-0 text-center sm:text-left">
                ...
                <div
                  class="flex flex-wrap items-center justify-center sm:justify-start gap-1 sm:gap-2 mt-2"
                >
                  <span
          ...
          <!-- Scrollable Content - Enhanced Responsive -->
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div class="bg-blue-50 rounded-lg p-3 sm:p-4 md:p-6">
                ...
                <div class="space-y-3 sm:space-y-4">
                  ...
                  <div>
                    ...
                    >
                    <p
                      class="text-xs sm:text-sm text-gray-900 bg-white p-2 rounded border min-h-[50px] sm:min-h-[60px] break-words"
                    >
              ...
              <div class="bg-green-50 rounded-lg p-3 sm:p-4 md:p-6">
                <h3
                  class="text-base sm:text-lg font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center gap-2"
                >
                  <GraduationCap class="w-4 h-4 sm:w-5 sm:h-5 text-green-600" />
                  Academic Information
                </h3>
                <div class="space-y-3 sm:space-y-4">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              ...
              <!-- Documents Section - Enhanced Responsive -->
              <div
                class="xl:col-span-2 bg-gray-50 rounded-lg p-3 sm:p-4 md:p-6"
              >
                <h3
                  class="text-base sm:text-lg font-semibold text-gray-800 mb-4 sm:mb-6 flex items-center gap-2"
                >
                  <FileText class="w-4 h-4 sm:w-5 sm:h-5 text-gray-600" />
                  Documents
                </h3>
                <div
                  class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-3 sm:gap-4"
                >
                  <!-- Document Cards - Enhanced Responsive -->
                  <!-- Aadhaar Card -->
                  <div
                  ...
                  >
                    ...
                    >
                      <div
                        class="flex items-center gap-2 text-xs text-green-700 bg-green-50 p-1.5 sm:p-2 rounded"
                      >
                      ...
                      <div class="flex flex-col sm:flex-row gap-1 sm:gap-2">
                        <button
                          ...
                          "
                          class="flex items-center justify-center gap-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 transition-colors"
                        >
                          <Eye class="w-3 h-3" />
                          View
                        </button>
                        <button
                          ...
                          "
                          class="flex items-center justify-center gap-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-green-600 text-white text-xs rounded hover:bg-green-700 transition-colors"
                        >
                  ...
                  >
                    <div class="flex items-center gap-2 mb-3">
                      <div class="p-1.5 sm:p-2 bg-red-100 rounded-lg">
                        <FileText class="w-3 h-3 sm:w-4 sm:h-4 text-red-600" />
                      </div>
                      <h4
                        class="text-xs sm:text-sm font-semibold text-gray-800"
                      >
                    ...
                    >
                      ...
                      <div class="flex flex-col sm:flex-row gap-1 sm:gap-2">
                        <button
                          @click="
                            viewDocument(viewingStudent.marksheet, 'Marksheet')
                          "
                          class="flex items-center justify-center gap-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-600 text-white text-xs rounded hover:bg-blue-700 transition-colors"
                        >
                          <Eye class="w-3 h-3" />
          ...
          <!-- Fixed Footer - Enhanced Responsive -->
          <div class="flex-shrink-0 p-3 sm:p-4 md:p-6 border-t border-gray-200">
            <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3">
              <button
                @click="closeDetailsModal"
                class="px-3 sm:px-4 py-2 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 transition-all duration-200 text-sm"
              >
                Close
              </button>
              <button
                @click="editStudent(viewingStudent)"
                class="inline-flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all duration-200 text-sm"
              >
                <Pencil class="w-4 h-4" />
                Edit Student
              </button>
      ...
      <!-- Document Viewer Modal - Enhanced Responsive -->
      <div
        v-if="showDocumentViewer"
        class="fixed inset-0 z-[9999] bg-black/90 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 animate-in fade-in-0 duration-300"
      >
        <div
          class="bg-white w-full max-w-xs sm:max-w-sm md:max-w-3xl lg:max-w-4xl xl:max-w-5xl max-h-[98vh] sm:max-h-[95vh] rounded-xl shadow-2xl relative flex flex-col overflow-hidden animate-in zoom-in-95 duration-300 mx-2 sm:mx-4"
        >
          <!-- Document Viewer Header - Enhanced Responsive -->
          <div
            class="flex-shrink-0 bg-gradient-to-r from-slate-50 to-gray-50 px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-gray-200/80 flex items-center justify-between"
          >
            <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1 pr-2">
              ...
              <div class="min-w-0 flex-1">
                <h3
                  class="text-sm sm:text-base md:text-lg font-semibold text-gray-900 truncate"
                >
            ...
            <button
              ...
              class="p-1.5 sm:p-2.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-full transition-all duration-200 hover:scale-105 flex-shrink-0"
          ...
          <!-- Document Content - Enhanced Responsive -->
          <div class="flex-1 overflow-hidden bg-gray-50">
            <div
              v-if="currentDocumentUrl"
              class="w-full h-full"
            >
              <!-- PDF Viewer - Enhanced Responsive -->
              <iframe
                v-if="
                ...
                title="PDF Viewer"
              ></iframe>
              <!-- Image Viewer - Enhanced Responsive -->
              <div
                v-else
                class="w-full h-full flex items-center justify-center p-2 sm:p-4 md:p-6"
              >
                <div
            ...
            >
              <div class="text-center">
                <div class="relative">
                  <div
                    class="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 border-3 sm:border-4 border-blue-100 border-t-blue-600 rounded-full animate-spin mx-auto mb-3 sm:mb-4"
                  ></div>
                  <div
                    class="absolute inset-0 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 border-3 sm:border-4 border-transparent border-r-blue-300 rounded-full animate-spin mx-auto"
                    style="
                ...
                <p class="text-sm sm:text-base font-medium text-gray-700 mb-1">
                  Loading document...
                </p>
          ...
          <!-- Document Actions - Enhanced Responsive Footer -->
          <div
            class="flex-shrink-0 bg-gradient-to-r from-slate-50 to-gray-50 px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-t border-gray-200/80 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0"
          >
            <div
              class="flex items-center gap-2 text-xs sm:text-sm text-gray-600 order-2 sm:order-1"
            >
              <div
                class="w-2 h-2 bg-green-500 rounded-full animate-pulse"
              ></div>
              <span class="hidden sm:inline">Document loaded successfully</span>
              <span class="sm:hidden">Loaded</span>
            </div>
            <div
              class="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto order-1 sm:order-2"
            >
              <button
                @click="closeDocumentViewer"
                class="px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-gray-200 text-sm"
              >
                Close
              </button>
              <button
                ...
                "
                class="inline-flex items-center justify-center gap-2 px-3 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white font-medium rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-200 shadow-lg hover:shadow-xl text-sm"
              >
