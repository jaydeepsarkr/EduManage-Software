                ...
                <div class="flex-1 sm:max-w-sm lg:max-w-md">
                  ...
                  <div class="relative group">
                    ...
                    <input
                      ...
                      class="w-full pl-10 pr-10 py-3 sm:py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm hover:bg-white/80 text-sm sm:text-base"
                    />
                ...
                >
                  ...
                  <div class="flex flex-wrap gap-3 sm:gap-6 text-xs sm:text-sm">
                    <span class="flex items-center">
                      <div
                        class="w-3 h-3 bg-emerald-500 rounded-full mr-2"
                      ></div>
                  ...
                  <table class="w-full">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="py-4 px-4">
                          <div
                            class="flex justify-center space-x-1 lg:space-x-2"
                          >
                            <button
                              @click="setAttendance(student._id, 'present')"
                              :disabled="isLoading"
...
<script setup>
  ...
  const isSearching = ref(false); // This will now only control the spinner, not disable the input
  ...
  const fetchFilteredStudents = async (page = 1) => {
    ...
    try {
      ...
      isSearching.value = false; // Ensure isSearching is reset after fetch completes
    }
  };
